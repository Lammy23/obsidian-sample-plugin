    ...
    private async renderStep() {
        ...
        if (inputVars.size > 0) {
            ...
            inputVars.forEach(varName => {
                ...
                // UI FIX: Mobile Keyboard Auto-Dismiss
            ...
            if (validEdges.length === 0) {
                if (this.callStack.length > 0) {
                    ...
                    const returnBtn = buttonContainer.createEl("button", { 
                        ...
                        attr: { style: "width: 100%; box-sizing: border-box; padding: 15px; cursor: pointer; font-weight: 600; font-size: 1.1em; border-radius: 8px; background-color: var(--interactive-accent); color: var(--text-on-accent);" }
                    });
                    returnBtn.onclick = () => {
                        this.callStack.pop(); 
                    ...
                    const finalRestartBtn = buttonContainer.createEl("button", { 
                        ...
                        attr: { style: "width: 100%; box-sizing: border-box; padding: 15px; cursor: pointer; font-weight: 600; font-size: 1.1em; border-radius: 8px; background-color: var(--background-modifier-border); color: var(--text-normal); border: none; margin-top: 10px;" }
                    });
